...
# [] son para crear una lista
    ...
    # si la cantidad de calificaciones es exactamente igual a 0
            return 0
    # regresa 0
...
print(f"La calificación de: {estudiante2.getNombre()} es: {estudiante2.mostrarPromedio()}")